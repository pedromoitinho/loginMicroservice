	...
	public void run(String... args) throws Exception {
		...
		List<FormQuestion> questions = Arrays.asList(
				...
				createQuestion(savedForm, "Qual serviço você utilizou?", QuestionType.SINGLE_CHOICE, 2, true,
						Arrays.asList("Consultoria em Segurança", "Treinamento NR-10", "Assessoria em RH",
								"Psicologia Organizacional", "Saúde Ocupacional")),
				createQuestion(savedForm, "Recomendaria nossos serviços para outras empresas?", QuestionType.SINGLE_CHOICE,
						3, true,
						Arrays.asList("Sim, definitivamente", "Provavelmente sim", "Talvez", "Provavelmente não", "Não")),
				createQuestion(savedForm, "Deixe um comentário sobre sua experiência:", QuestionType.TEXTAREA, 4, false,
						null),
